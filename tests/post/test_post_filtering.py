...
class TestPostFiltering:
    ...
    def test_post_on_category_filtering(self, api_client, posts, categories):
        ...
        response = api_client.get(f'/posts?category={category_title}&page=1')
    ...
    def test_post_on_tag_filtering(self, api_client, posts, tags):
        ...
        response = api_client.get(f'/posts?tags={tag_title}&page=1')
        assert response.status_code == 200
        assert len(response.data) == 2
        ...
        response = api_client.get(f'/posts?tags={tag_title1},{tag_title2}&page=1')
        assert response.status_code == 200
        assert len(response.data) == 2
        ...
        response = api_client.get(f'/posts?tags={tag_title1}&tags={tag_title2}&page=1')
    ...
    def test_post_on_category_tag_filtering(self, api_client, posts, categories, tags):
        ...
        response = api_client.get(f'/posts?category={category_title}&tags={tag_title}&page=1')
        assert response.status_code == 200
    ...
    def test_post_on_date_filtering(self, api_client, posts):
        ...
        response = api_client.get(f'/posts?startDate={start_date}&endDate={end_date}&page=1')
        assert response.status_code == 200
        assert len(response.data) == 2
    ...
    def test_post_on_time_of_day_filtering(self, api_client, posts):
        time_of_day = TIME_OF_DAY['AFTERNOON']
        response = api_client.get(f'/posts?timeOfDay={time_of_day}&page=1')
        assert response.status_code == 200
        assert len(response.data) == 2
    ...
    def test_post_on_location_filtering(self, api_client, posts):
        location = 'location'
        response = api_client.get(f'/posts?location={location}&page=1')
        assert response.status_code == 200
        assert len(response.data) == 2
